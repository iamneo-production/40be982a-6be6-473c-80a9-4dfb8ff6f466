                ...
                </Navbar>
            {
                ...
                <>
                    <>
                    {
                        showAddPopUp?
                        <>
                            <div class="container  date-c col-5 p-5 mt-5 border-dark    position-absolute" style={{top:100,left:448}}>
                        ...
                        <br/><center>
                        <button type="button" class=" add-b btn btn-success" aria-label="Left Align"  onClick={()=>{ setShowAddPopUp(!showAddPopUp)}}>
                            Add
                            </button>&nbsp;&nbsp;
