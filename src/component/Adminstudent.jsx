        ...
        <>
            {
                showAddPopUp?
                <><center>
                    <div class="container-4 col-5 p-5 mt-5 border-dark " style={{top:100,left:448}}>
           ...
           
           {
            ...
            <div class = "container col-3 mt-5 ">
                ...
                <button type="button" id="addStudent" class="btn btn-danger" onClick={()=>{setShowAddPopUp(!showAddPopUp)}} >Add</button><br/>
            </div>
                        ...
                        allStudents && allStudents.map((val)=>{
                            return(
                                <tr>
                                    ...
                                    <td> {val.age}</td>
                                    <td>
                                        <button type="button" id="login_btn" class="btn btn-primary" onClick={()=>{setEditData(val);setShowEditPopUp(true)}}>Edit</button>&nbsp;&nbsp;
