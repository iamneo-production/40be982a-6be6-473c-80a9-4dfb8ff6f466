    ...
    return(
        <>

            {
                showAddPopUp?
                <>   <center>
                    <div class="container-5 col-5 p-5 mt-5 border-dark  bg-success  " style={{top:100,left:448}}>
                        ...
                        <button type="button" id="close_btn" class="btn btn-danger" onClick={()=>{setShowAddPopUp(false)}}>close</button><br/>
...

            {
                ...
                <>
                    <div class="container col-5 p-5 mt-5 border-dark  bg-warning  position-absolute" style={{top:100,left:448}}>
                        ...
                        <button type="button" id="close_btn" class="btn btn-primary" onClick={()=>{setShowEdit(false)}}>close</button><br/>
            ...
            <div class = "container col-3 mt-5 ">
                ...
                <button type="button" id="login_btn" class="btn btn-info" onClick={()=>{setShowAddPopUp(!showAddPopUp)}} >Add</button><br/>
            </div>
                ...
                <tbody>
                    {
                        allInstitution && allInstitution.map((val)=>{
                            return(<tr>
                                ...
                                <td>{val.instituteName}</td>
                                <td>
                                    <button type="button" id="login_btn" class="btn btn-primary" onClick={()=>{setShowEdit(true);setEditData(val)}}>Edit</button>&nbsp;&nbsp;
